...
public class ConfigGallery {
    ...
    public static PictureSelectionModel applyInstagramOptions(Context context, PictureSelectionModel selectionModel) {
        return selectionModel
                .setLanguage(LanguageConfig.ARABIC)
                .isCheckOriginalImage(true)
                .enableInstagramStyleVideoTab(false)
    ...
    public static PictureParameterStyle createInstagramStyle(Context context) {
        ...
        // 相册列表标题栏右侧上拉箭头
        mPictureParameterStyle.pictureTitleUpResId = com.luck.picture.lib.R.drawable.picture_arrow_up;
        // 相册列表标题栏右侧下拉箭头
        mPictureParameterStyle.pictureTitleDownResId = com.luck.picture.lib.R.drawable.picture_arrow_down;
        // 相册文件夹列表选中圆点
        ...
        // 标题栏字体颜色
        if (currentTheme == THEME_STYLE_DARK) {
            mPictureParameterStyle.pictureTitleTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_white);
        } else if (currentTheme == THEME_STYLE_DARK_BLUE) {
            mPictureParameterStyle.pictureTitleTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_white);
        } else {
            mPictureParameterStyle.pictureTitleTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_black);
        }
        // 相册右侧取消按钮字体颜色  废弃 改用.pictureRightDefaultTextColor和.pictureRightDefaultTextColor
        if (currentTheme == THEME_STYLE_DARK) {
            mPictureParameterStyle.pictureRightDefaultTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_1766FF);
        } else if (currentTheme == THEME_STYLE_DARK_BLUE) {
        ...
        // 相册父容器背景色
        if (currentTheme == THEME_STYLE_DARK) {
            mPictureParameterStyle.pictureContainerBackgroundColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_black);
        } else if (currentTheme == THEME_STYLE_DARK_BLUE) {
            mPictureParameterStyle.pictureContainerBackgroundColor = Color.parseColor("#18222D");
        } else {
            mPictureParameterStyle.pictureContainerBackgroundColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_white);
        }
        // 相册列表勾选图片样式
        mPictureParameterStyle.pictureCheckedStyle = com.luck.picture.lib.R.drawable.picture_instagram_num_selector;
        // 相册列表底部背景色
        mPictureParameterStyle.pictureBottomBgColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_fa);
        // 已选数量圆点背景样式
        mPictureParameterStyle.pictureCheckNumBgStyle = com.luck.picture.lib.R.drawable.picture_num_oval;
        // 相册列表底下预览文字色值(预览按钮可点击时的色值)
        mPictureParameterStyle.picturePreviewTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_fa632d);
        // 相册列表底下不可预览文字色值(预览按钮不可点击时的色值)
        mPictureParameterStyle.pictureUnPreviewTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_9b);
        // 相册列表已完成色值(已完成 可点击色值)
        mPictureParameterStyle.pictureCompleteTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_fa632d);
        // 相册列表未完成色值(请选择 不可点击色值)
        mPictureParameterStyle.pictureUnCompleteTextColor = ContextCompat.getColor(context, com.luck.picture.lib.R.color.picture_color_9b);
        // 外部预览界面删除按钮样式
...
//        // 自定义相册右侧文本内容设置
        mPictureParameterStyle.pictureRightDefaultText = context.getString(com.luck.picture.lib.R.string.next);
    ...
    public static void setCurrentTheme(int currentTheme) {
        ConfigGallery.currentTheme = currentTheme;
    }
}
